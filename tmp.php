...
<div class='row'><h4 class='text-center' style='color: #5CB85C; font-weight: bold;'>Taxonomie</h4></div>
</div>
</div>
...
?>
<div class="row" id="<?php echo "tr".$i++ ?>"  onclick="taxonimie(nbTr.value)"><label class="col-xs-12">Nom retenu </label><label class="col-xs-10"><?php echo $donnees1['LB_NOM']; ?> <?php echo $donnees1['LB_AUTEUR']."<h6>(Pour déplier les synonymes, cliquer sur le nom retenu)</h6>"; ?></label></div>
...
{ 
?>
<div id="<?php echo "tr".$i++ ?>" class="row" style="display: none">
...
<div class='row'><h4 class='text-center' style='color: #5CB85C; font-weight: bold;'>Systématique</h4></div>
<table>
<div class="row">
<label class="col-xs-1"> Phylum  </label>
<span class="col-xs-4"> <?php echo $donneesReferentiel['PHYLUM']; ?> </span>
<label class="col-xs-1  col-xs-offset-1"> Classe  </label>
<span class="col-xs-4"> <?php echo $donneesReferentiel['CLASSE']; ?> </span>
</div>
<div class="row">
<label class="col-xs-1"> Ordre  </label>
<span class="col-xs-4"> <?php echo $donneesReferentiel['ORDRE']; ?></span>

<label class="col-xs-1  col-xs-offset-1"> Famille </label>
<span class="col-xs-4"><?php echo $donneesReferentiel['FAMILLE']; ?> </span>
...
<label class="col-xs-1"> Domaine  </label> 
<span class="col-xs-3"> <?php echo $donnees['domaine'];?></span>
...
<span class="col-xs-6"> <?php echo $donnees['codeherbier']; ?>  </span>
</div>
<div class="row">
<label class="col-xs-4"> N°Herbier </label>
<span class="col-xs-6"><?php echo $donnees['herbier']; ?>  </span>
</div>
</div>
</div>
...
<div class="row">
<label class="col-xs-1"> Collaboration  </label>
<span class="col-xs-4"> <?php if(!empty($donnees['collaboration'])) echo $donnees['collaboration']; ?> </span>
</div>
...
<INPUT TYPE="button" VALUE="Modifier" class="recherche col-xs-1" onclick="self.location.href='./ModifierCreation?type=1&id=<?php echo $_GET['id'] ?>'">
</div> <!-- fin div navfiche-technique-->
<?php }  

if($_SESSION['droitAdmin']==1){ ?><INPUT TYPE="button" VALUE="Supprimer" class="recherche  col-xs-offset-1 col-xs-1" onclick="self.location.href='/edition?id=<?php echo $_GET['id'] ?>&bouton=sup'"><?php } ?> <input name="button" type="button" value="Imprimer" onClick="window.print()" class="recherche col-xs-offset-1 col-xs-1" >
<INPUT TYPE="button" VALUE="Retour" class="recherche  col-xs-offset-1 col-xs-1" onclick="window.history.back();" >
...
if($index>0){
$index=$index-1;
echo "<input type='button' value='Précédent' class='recherche col-xs-offset-1 col-xs-1' onclick=self.location.href='./?id=".$liste[$index]."&liste=".implode(",",$liste)."&index=".$index ."'>";
}

$index=$index+2;
if($index<count($liste)){
echo "<input type='button' value='Suivant' class='recherche col-xs-offset-1 col-xs-1' onclick=self.location.href='./?id=".$liste[$index]."&liste=".implode(",",$liste)."&index=".$index ."'>";
}
...
<script>init(<?php echo $_REQUEST['id'];?>)</script>
